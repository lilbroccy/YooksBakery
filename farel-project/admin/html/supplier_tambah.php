    ...
    <div class="layout-wrapper layout-content-navbar">
      <div class="layout-container">
        ...
        if(isset($_POST['simpan'])){
            ...
            $ambil = $koneksi->query("INSERT INTO supplier (id_toko, nama_supplier) VALUES ('$id_toko', '$nama')");

            if (isset($ambil)) {
              echo "<script>
                      Swal.fire({
                          icon: 'success',
                          title: 'INPUT DATA SUPPLIER BERHASIL',
                          text: 'Data Supplier Telah Bertambah'
                      }).then((result) => {
