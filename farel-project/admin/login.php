...
body{
    ...
    background-image: url('../asset/image/image-admin/formregister.php');
...
<body>
    ...
    <form action="login.php" method="post">
        <!-- <div class="text-center">
            <img src="/farel-project/asset/image/image-admin/Logo.png" width="800">
        </div> -->
        <h3 class="background-dark">Login</h3>

        <label for="username">Username</label>
        <input type="text" placeholder="Email" id="username" name="txt_email">
