...
<body>
        ...
        <div class="card-deck">
          ...
          <div class="card">
            ...
            <div class="card-body">
              ...
              <p class="card-text">
                Makanan yang dipanggang atau dimasak yang biasanya kecil, datar, dan manis
              </p>
            </div>
          </div>
          <div class="card">
            ...
            <div class="card-body">
              <h5 class="card-title">Jajan Tradisional</h5>
              <p class="card-text">
                Jajanan yang berasal dari bermacam daerah. Kita mengangkat Jajanan
          ...
          <div class="card" style="width: 18rem;">
            <img src="https://assets.promediateknologi.com/crop/0x0:0x0/750x500/photo/kulinear/2021/07/WhatsApp-Image-2021-07-06-at-17.55.28.jpeg" class="card-img-top" alt="..." width="200px" height="200px">
              <div class="card-body">
                ...
                <p class="card-text"></p>
                <a href="#" class="d-grid gap-2 d-md-block mx-auto btn custom_orange-btn">Beli</a>
              </div>
          </div>
          <div class="card" style="width: 18rem;">
  ...
  <!--<section class="fruit_section">
    <div class="container">
      ...
      <p class="custom_heading-text">
        Semua Roti yang kami sediakan selalu disajikan dengan Fresh dan baru diangkat dari oven untuk menjamin
        kualitas Roti kami 
      </p>
      <div class="row layout_padding2">
        <div class="col-md-8">
          <div class="fruit_detail-box">
            ...
            <p class="mt-4 mb-5">
              Roti dengan Topping cream coffe dan isian mentega yang disajikan dalam keadaan hangat
            </p>
            <div>
              <a href="" class="custom_dark-btn">
                Buy Now
      ...
      <div class="row layout_padding2">
        <div class="col-md-8">
          <div class="fruit_detail-box">
            ...
            <p class="mt-4 mb-5">
              Roti bun dengan isian Mesis dan Keju
            </p>
            <div>
              <a href="" class="custom_dark-btn">
                Buy Now
      ...
      <div class="row layout_padding2-top layout_padding-bottom">
        <div class="col-md-8">
          <div class="fruit_detail-box">
            ...
            <p class="mt-4 mb-5">
              Roti dengan topping sosis dan Saus, seperti pizza namun dengan versi kecil
            </p>
            <div>
              <a href="" class="custom_dark-btn">
                Buy Now
